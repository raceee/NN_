...
def init_layers(nn_architecture, seed=99):
    ...
    for idx, layer in enumerate(nn_architecture):
        ...
        print("layer_input_size", layer_input_size)
        print("layer_output_size", layer_output_size)
        ...
        print("W",param_values['W' + str(layer_idx)])
        print("b", param_values['b' + str(layer_idx)])
        print(" ")
        print(" ")
        print(" ")
        print(" ")
...
def single_layer_forward_propagation(A_prev, W_curr, b_curr, activation="relu"):
    ...
    return activation_function(Z_curr), Z_curr #Z_curr is needed for backward step
...
def single_layer_backward_propagation(dA_curr, W_curr, b_curr, Z_curr, A_prev, activation="relu"):
    ...
    if activation is "relu":
        ...
        raise ("Non-supporrted activation function")
...
def full_backward_propagation(Y_hat, Y, memory, params_values, nn):
    grads_values = {}
    m = Y.shape[1]
